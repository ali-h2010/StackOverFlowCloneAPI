...
{ 
    ...
    { 
        /// <summary>
        /// Posting new answer to a question
        /// </summary>
        
        /// <param name="body">Answer object that needs to be added to a question</param>
        /// <response code="200">Answer was added successfully</response>
        /// <response code="405">Invalid input</response>
        [HttpPost]
        [Route("/v2/SubmitAnswer")]
        [ValidateModelState]
        [SwaggerOperation("AddAnswer")]
        public virtual IActionResult AddAnswer([FromBody]Answer body)
        { 
