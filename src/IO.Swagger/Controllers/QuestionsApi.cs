...
{ 
    ...
    { 
        /// <summary>
        /// Posting new question to the system
        /// </summary>
        
        /// <param name="body">Question object that needs to be added</param>
        /// <response code="200">Question was added successfully</response>
        /// <response code="405">Invalid input</response>
        [HttpPost]
        [Route("/v2/SubmitQuestion")]
        [ValidateModelState]
        [SwaggerOperation("AddQuestion")]
        public virtual IActionResult AddQuestion([FromBody]Question body)
        { 
